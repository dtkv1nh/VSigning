...
const creator = () => {
  ...
  flagDiv.innerHTML = `<img src="videos/pic.jpg" id="eat">`;
  dragContainer.appendChild(flagDiv);
  const flagDiv2 = document.createElement("div");
  flagDiv2.classList.add("draggable-image");
  flagDiv2.setAttribute("draggable", true);
  if (isTouchDevice()) {
    flagDiv2.style.position = "absolute";
  }
  flagDiv2.innerHTML = `<img src="videos/pic.jpg" id="I">`;
  dragContainer.appendChild(flagDiv2);
  const flagDiv3 = document.createElement("div");
  flagDiv3.classList.add("draggable-image");
  flagDiv3.setAttribute("draggable", true);
  if (isTouchDevice()) {
    flagDiv3.style.position = "absolute";
  }
  flagDiv3.innerHTML = `<img src="videos/pic.jpg" id="apple">`;
  dragContainer.appendChild(flagDiv3);
  buttonContainer.innerHTML += `<div class="btn" id="btn_1">
    <div class="play"></div>
    <p>Xem video</p>
  </div>
  <div class="clip" id="clip_1">
    <video src="videos/eat.mp4" controls loop></video>
  ...
  <div class="clip" id="clip_2">
    <video src="videos/I.mp4" controls loop></video>
  ...
  <div class="clip" id="clip_3">
    <video src="videos/apple.mp4" controls loop></video>
  ...
  countryDiv1.innerHTML = `<div class='countries' data-id='I'></div>`;
  dropContainer.appendChild(countryDiv1);
  const countryDiv2 = document.createElement("div");
  countryDiv2.innerHTML = `<div class='countries' data-id='apple'></div>`;
  dropContainer.appendChild(countryDiv2);
  const countryDiv = document.createElement("div");
  countryDiv.innerHTML = `<div class='countries' data-id='eat'></div>`;
